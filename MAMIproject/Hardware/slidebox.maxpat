...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.0, 302.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 198.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 187.0, 262.0, 55.0, 22.0 ],
									"style" : "",
									"text" : "r scalein"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 271.0, 342.0, 66.0, 22.0 ],
									"style" : "",
									"text" : "r root-note"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 30.0, 392.0, 260.0, 22.0 ],
									"style" : "",
									"text" : "+ 48"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 292.0, 176.0, 22.0 ],
									"style" : "",
									"text" : "pack 60 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 324.0, 67.0, 22.0 ],
									"style" : "",
									"text" : "nth $2 $1"
								}
...
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 30.0, 355.0, 66.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 96.0, 355.0, 50.0, 20.0 ],
									"style" : "",
									"text" : "scales"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 488.0, 161.5, 150.0, 22.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 263.0, 109.0, 75.0, 22.0 ],
									"style" : "",
									"text" : "Root Note"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 418.0, 142.5, 68.0, 22.0 ],
									"style" : "",
									"text" : "s root-note"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 418.0, 102.5, 196.0, 34.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 202.0, 72.0, 196.0, 34.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 188.0, 147.0, 170.0, 22.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 44.0, 109.0, 55.0, 22.0 ],
									"style" : "",
									"text" : "Scale"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 187.0, 232.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "s scalein"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 187.0, 171.0, 85.0, 22.0 ],
									"style" : "",
									"text" : "loadmess 13"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 187.0, 198.0, 165.0, 25.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 29.0, 78.0, 151.0, 25.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 53.0, 231.0, 58.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 80.0, 166.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.0, 44.0, 507.0, 95.0 ],
					"size" : 1024.0,
					"style" : ""
				}
