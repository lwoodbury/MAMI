...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 164.0, 167.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"id" : "obj-13",
					"items" : [ "no plug-in", ",", "AUAudioFilePlayer", ",", "AUBandpass", ",", "AUDelay", ",", "AUDistortion", ",", "AUDynamicsProcessor", ",", "AUFilter", ",", "AUGraphicEQ", ",", "AUHighShelfFilter", ",", "AUHipass", ",", "AULowpass", ",", "AULowShelfFilter", ",", "AUMatrixMixer", ",", "AUMatrixReverb", ",", "AUMixer", ",", "AUMixer3D", ",", "AUMultibandCompressor", ",", "AUMultiChannelMixer", ",", "AUNBandEQ", ",", "AUNetReceive", ",", "AUNetSend", ",", "AUParametricEQ", ",", "AUPeakLimiter", ",", "AUPitch", ",", "AURogerBeep", ",", "AUSampleDelay", ",", "AUSampler", ",", "AUScheduledSoundPlayer", ",", "AUSoundFieldPanner", ",", "AUSphericalHeadPanner", ",", "AUVectorPanner", ",", "DLSMusicDevice", ",", "HRTFPanner", ",", "MIDISynth", ",", "RoundTripAAC", ",", "Crystal", ",", "Crystal", ",", "20 Bands Eq", ",", "5 Band Eq", ",", "Bassdrum", ",", "Buff rice", ",", "Compressor", ",", "Convolution reverb mono", ",", "Convolution reverb stereo", ",", "DC Blocker", ",", "Flying monkey synth", ",", "Funky repeater", ",", "Gate", ",", "Graphic Equalizer", ",", "Hum remover", ",", "Limiter", ",", "MIDI Filter", ",", "Multiband freeverb", ",", "Multiband scraper", ",", "Rainy synth", ",", "Simple reverb", ",", "Swamp buffer", ",", "Valve warmer", ",", "Width Enhancer", ",", "Obxd", ",", "TyrellN6" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
