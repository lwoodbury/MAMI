...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "/OSCaddress/button1" ],
									"patching_rect" : [ 197.0, 174.0, 133.0, 22.0 ],
									"style" : "",
									"text" : "t /OSCaddress/button1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "00" ],
									"patching_rect" : [ 153.0, 174.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "t \"00\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "note-48" ],
									"patching_rect" : [ 87.5, 174.0, 58.0, 22.0 ],
									"style" : "",
									"text" : "t note-48"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "b1" ],
									"patching_rect" : [ 50.0, 174.0, 31.0, 22.0 ],
									"style" : "",
									"text" : "t b1"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 78.0, 119.0, 22.0 ],
					"style" : "",
					"text" : "append Button Input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 112.5, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 43.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 545.25, 138.0, 77.5, 33.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 560.5, 138.0, 47.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 26.75, 6.0, 140.5, 20.0 ],
					"proportion" : 0.39,
					"style" : ""
