...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.5, 113.0, 70.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 330.200012, 13.5, 76.0, 22.0 ],
					"style" : "",
					"text" : "D1_CTRL2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.666656, 38.0, 124.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 140.5, 13.5, 140.0, 20.0 ],
					"style" : "",
					"text" : "Synth",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.125, 74.0, 76.0, 30.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 102.5, 3.0, 216.0, 40.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.541656, 703.0, 116.0, 22.0 ],
					"style" : "",
					"text" : "send~ MAMIRIGHT"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.875, 703.0, 108.0, 22.0 ],
					"style" : "",
					"text" : "send~ MAMILEFT"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 202.0, 536.0, 77.0, 114.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 321.825012, 171.5, 77.0, 114.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 28.0, 59.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "unpack s i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 390.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "pipe 1000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 7.0, 356.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t i 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 7.0, 294.0, 308.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 85.0, 509.5, 33.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, 475.5, 92.0, 22.0 ],
					"style" : "",
					"text" : "scale 0. 1. 0. 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 7.0, 443.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 409.0, 109.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 413.0, 366.0, 558.0, 223.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 202.0, 374.0, 128.0, 128.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 524.0, 220.0, 246.0, 123.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 768.0, 685.0, 187.0, 22.0 ],
					"style" : "",
					"text" : "pattrforward Oscillator::Waveform"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 768.0, 638.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 856.0, 717.0, 159.0, 47.0 ],
					"style" : "",
					"text" : "lock patcher and double Click on Pattrstorage to see all names"
				}
...
,
					"patching_rect" : [ 196.0, 220.0, 314.0, 116.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.699997, 53.5, 314.0, 116.0 ],
					"varname" : "Oscillator",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 768.0, 717.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"client_rect" : [ 100, 100, 598, 771 ],
						"parameter_enable" : 0,
