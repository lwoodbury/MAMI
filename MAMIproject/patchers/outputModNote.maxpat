...
,
		"rect" : [ 472.0, 164.0, 1019.0, 800.0 ],
		"openrect" : [ 0.0, 0.0, 697.0, 0.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 313.875, 371.5, 29.5, 22.0 ],
					"style" : "",
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 313.875, 347.5, 68.0, 22.0 ],
					"style" : "",
					"text" : "random 51"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 380.0, 394.0, 150.0, 33.0 ],
					"style" : "",
					"text" : "chrom 1 - 51\nionian 1 -36"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 313.875, 399.5, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 254.899994, 315.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.75, 686.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.75, 652.5, 105.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 37.625, 501.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 536.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "v #0_1note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 208.5, 284.0, 251.0, 22.0 ],
					"style" : "",
					"text" : "gate 6"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 757.833313, 155.0, 34.0, 22.0 ],
									"style" : "",
									"text" : "t b 6"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 677.666687, 155.0, 34.0, 22.0 ],
									"style" : "",
									"text" : "t b 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 597.5, 155.0, 34.0, 22.0 ],
									"style" : "",
									"text" : "t b 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 517.333313, 151.0, 34.0, 22.0 ],
									"style" : "",
									"text" : "t b 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 437.166656, 151.0, 34.0, 22.0 ],
									"style" : "",
									"text" : "t b 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 356.0, 151.0, 34.0, 22.0 ],
									"style" : "",
									"text" : "t b 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 369.75, 298.0, 30.0, 30.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 559.0, 197.5, 190.0, 22.0 ],
									"style" : "",
									"text" : "script hide note, script show scale"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 357.0, 102.0, 500.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 356.0, 197.5, 190.0, 22.0 ],
									"style" : "",
									"text" : "script hide scale, script show note"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 168.5, 183.0, 154.0, 22.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 167.5, 244.0, 60.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 790.375, 548.0, 189.0, 96.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 253.300003, 221.5, 169.0, 82.0 ],
					"varname" : "quant",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 362.0, 226.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.300003, 175.5, 226.0, 128.0 ],
					"varname" : "note",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 313.875, 432.5, 226.0, 151.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.300003, 152.5, 226.0, 151.0 ],
					"varname" : "scale",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 67.75, 244.0, 34.0, 20.0 ],
					"rounded" : 5.0,
					"style" : "",
					"text" : "Back",
					"texton" : "In",
...
,
					"patching_rect" : [ 67.75, 272.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 45.75, 303.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 443.107117, 121.0, 59.0, 62.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 467.0, 85.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "r thePath"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 323.375, 617.5, 62.25, 617.5 ],
					"source" : [ "obj-122", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 177.0, 297.5, 55.25, 297.5 ],
					"source" : [ "obj-125", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 264.399994, 348.0, 300.0, 348.0, 300.0, 639.0, 105.25, 639.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 218.0, 343.5, 47.125, 343.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 1 ],
					"midpoints" : [ 73.5, 604.75, 62.25, 604.75 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 106.0, 118.5, 19.25, 118.5 ],
					"order" : 2,
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 2 ],
					"midpoints" : [ 47.125, 569.75, 105.25, 569.75 ],
					"source" : [ "obj-7", 0 ]
				}
