...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 336.0, 128.0, 22.0 ],
					"style" : "",
					"text" : "ctrlName D3_CTRL5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 289.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "D3_CTRL5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 319.0, 88.0, 22.0 ],
					"style" : "",
					"text" : "v #0_ctrlName"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.75, 265.875, 106.0, 22.0 ],
					"style" : "",
					"text" : "prepend ctrlName"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 99.25, 206.875, 34.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 117.75, 19.875, 34.0, 18.0 ],
					"rounded" : 5.0,
					"style" : "",
					"text" : "Back",
					"texton" : "In",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 965.75, 88.875, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 289.0, 15.5, 15.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.5, 383.0, 426.25, 112.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.25, 1.5, 428.0, 310.0 ],
					"varname" : "outMod",
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 19.75, 311.0, 30.0, 30.0 ],
									"style" : "",
									"varname" : "u226009975[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.083334, 183.0, 142.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 357.0, 102.0, 262.0, 22.0 ],
									"style" : "",
									"text" : "sel \"Simple Trigger\" \"Note Trigger\" \"FX Control\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "bang", "bang", "bang", "" ],
									"patching_rect" : [ 43.75, 114.0, 53.0, 22.0 ],
									"style" : "",
									"text" : "t b b b s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 55.083332, 217.0, 114.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 189.833328, 217.0, 154.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 110.75, 317.0, 30.0, 30.0 ],
									"style" : "",
									"varname" : "u226009975"
								}
...
,
					"patching_rect" : [ 8.5, 219.875, 60.0, 22.0 ],
...
,
					"patching_rect" : [ 99.25, 234.875, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 99.25, 265.875, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.5, 61.75, 424.25, 123.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.25, 1.5, 428.0, 310.0 ],
					"varname" : "outModChooser",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 477.0, 34.0, 91.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.75, 204.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.25, 250.875, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 941.75, 88.875, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 289.0, 323.5, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 547.75, 191.875, 34.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 117.75, 323.5, 34.0, 18.0 ],
					"rounded" : 5.0,
					"style" : "",
					"text" : "Back",
					"texton" : "In",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 4.75, 316.0, 30.0, 30.0 ],
									"style" : "",
									"varname" : "u226009975[1]"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 555.0, 174.0, 73.0, 22.0 ],
									"style" : "",
									"text" : "t outputMax"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 555.0, 217.0, 247.0, 22.0 ],
									"style" : "",
									"text" : "script sendbox outBpat replace $1, ctrlName"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "outputSynth" ],
									"patching_rect" : [ 819.0, 174.0, 81.0, 22.0 ],
									"style" : "",
									"text" : "t outputSynth"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "outputMIDI" ],
									"patching_rect" : [ 357.0, 174.0, 76.0, 22.0 ],
									"style" : "",
									"text" : "t outputMIDI"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 357.0, 217.0, 192.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 43.75, 217.0, 115.0, 22.0 ],
									"style" : "",
									"text" : "script show outBpat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 179.5, 217.0, 172.0, 22.0 ],
									"style" : "",
									"text" : "script hide outputChooserBpat"
								}
...
,
					"patching_rect" : [ 477.0, 189.875, 60.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 477.0, 383.0, 426.25, 112.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.25, 308.5, 428.0, 310.0 ],
					"varname" : "outBpat",
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 135.0, 83.0, 110.0, 22.0 ],
									"style" : "",
									"text" : "script hide outBpat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 83.0, 141.0, 22.0 ],
									"style" : "",
									"text" : "script hide buttonModule"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 398.75, 83.0, 177.0, 22.0 ],
									"style" : "",
									"text" : "script show outputChooserBpat"
								}
...
,
					"patching_rect" : [ 547.75, 219.875, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.0, 64.625, 423.0, 117.25 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.25, 308.5, 428.0, 310.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 518.0, 250.875, 69.0, 22.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"style" : "",
					"text" : "thispatcher"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 18.0, 310.9375, 251.5, 310.9375 ],
					"source" : [ "obj-10", 0 ]
				}
