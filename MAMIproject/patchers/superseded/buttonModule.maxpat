...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 221.0, 191.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "MIDIbut"
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 82.0, 6.0, 75.0, 22.0 ],
					"rounded" : 5.0,
					"style" : "",
					"text" : "Delete All",
					"texton" : "Delete All",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 249.0, 137.0, 22.0 ],
									"style" : "",
									"text" : "pack 0 33 button1 hiBut"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 386.0, 265.0, 99.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 201.0, 265.0, 99.0, 22.0 ],
									"style" : "",
									"text" : "pack i 33 s hiBut"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 179.0, 204.0, 34.0, 22.0 ],
									"style" : "",
									"text" : "+ 96"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script newobject bpatcher buttonBpat @args $3 @varname $3 @patching_position $1 $2, script size $3 101 137, script sendbox $3 presentation 1, script connect receiver 0 $3 0, script sendbox $3 args $4"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 353.0, 242.0, 290.5, 242.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 353.0, 242.0, 177.5, 242.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 120.0, 192.5, 34.0, 22.0 ],
					"style" : "",
					"text" : "t b b"
				}
