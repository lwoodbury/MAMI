...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "/OSCaddress/fader1" ],
									"patching_rect" : [ 195.0, 174.0, 127.0, 22.0 ],
									"style" : "",
									"text" : "t /OSCaddress/fader1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "00" ],
									"patching_rect" : [ 144.0, 174.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "t \"00\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "cc-5" ],
									"patching_rect" : [ 95.5, 174.0, 40.0, 22.0 ],
									"style" : "",
									"text" : "t cc-5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 214.0, 96.0, 22.0 ],
									"style" : "",
									"text" : "prepend symbol"
								}
...
,
					"patching_rect" : [ 163.0, 259.0, 43.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 85.0, 115.0, 22.0 ],
					"style" : "",
					"text" : "append Fader Input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 113.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 143.5, 77.5, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 26.75, 6.0, 140.5, 20.0 ],
					"style" : "",
					"text" : "#1 Fader Input",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.25, 143.5, 47.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 26.75, 6.0, 140.5, 20.0 ],
					"proportion" : 0.39,
					"style" : ""
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.0, 298.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "symbol pot1"
				}
