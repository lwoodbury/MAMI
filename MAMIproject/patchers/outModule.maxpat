...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 492.5, 280.0, 34.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.75, 9.5, 34.0, 18.0 ],
					"rounded" : 5.0,
					"style" : "",
					"text" : "Back",
					"texton" : "In",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 197.083328, 275.0, 424.0, 35.0 ],
									"style" : "",
									"text" : "script sendbox outBpat replace outputVST, script hide outChooserBpat, script show outBpat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 183.083328, 101.0, 33.0, 22.0 ],
									"style" : "",
									"text" : "t b s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 99.416664, 106.0, 33.0, 22.0 ],
									"style" : "",
									"text" : "t b s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 32.041668, 101.0, 33.0, 22.0 ],
									"style" : "",
									"text" : "t b s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.041668, 349.0, 142.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 113.416664, 214.0, 507.0, 35.0 ],
									"style" : "",
									"text" : "script sendbox outBpat replace outputSamplePlayer, script hide outChooserBpat, script show outBpat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 46.041668, 173.0, 505.0, 22.0 ],
									"style" : "",
									"text" : "script sendbox outBpat replace outputSynth, script hide outChooserBpat, script show outBpat"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 43.75, 66.0, 228.0, 22.0 ],
									"style" : "",
									"text" : "sel \"Internal Synth\" \"Sample Player\" VST"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 43.75, 401.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 10.25, 205.5, 36.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.5, 415.5, 84.0, 22.0 ],
					"style" : "",
					"text" : "prepend send"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 366.5, 453.5, 51.0, 22.0 ],
					"style" : "",
					"text" : "forward"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 381.5, 351.5, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.5, 379.5, 145.0, 22.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 317.0, 137.0, 137.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 20.0, 137.0, 110.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 146.75, 137.0, 161.0, 22.0 ],
									"style" : "",
									"text" : "script show outChooserBpat"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 64.75, 415.5, 223.0, 107.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 79.25, 8.5, 261.0, 103.0 ],
					"varname" : "outChooserBpat",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 517.5, 482.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.25, -0.5, 419.0, 324.0 ],
					"proportion" : 0.39,
					"style" : ""
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 19.75, 253.25, 356.5, 253.25 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-6::obj-55" : [ "Waveform", "Waveform", 0 ],
			"obj-6::obj-97" : [ "toggle[16]", "toggle", 0 ],
			"obj-6::obj-56" : [ "Stereo", "Stereo", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "outputChooserBpat.maxpat",
