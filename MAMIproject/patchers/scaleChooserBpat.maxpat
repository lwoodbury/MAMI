...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"format" : 4,
					"htricolor" : [ 0.921569, 0.219608, 0.164706, 1.0 ],
					"id" : "obj-110",
					"maxclass" : "number",
					"numinlets" : 1,
					"numoutlets" : 2,
					...
					"presentation" : 1,
					"presentation_rect" : [ 81.300003, 61.5, 50.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 38.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 48"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 303.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 337.25, 173.5, 20.0, 22.0 ],
					"style" : "",
					"text" : "t i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.25, 210.5, 35.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 192.800003, 108.5, 35.0, 26.0 ],
					"style" : "",
					"text" : "0",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 290.75, 173.5, 32.0, 22.0 ],
					"style" : "",
					"text" : "* 12"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.75, 133.0, 53.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 169.800034, 86.0, 48.0, 20.0 ],
					"style" : "",
					"text" : "Octave",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 290.75, 125.5, 25.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 173.300034, 105.0, 25.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 192.0, 128.5, 29.5, 22.0 ],
					"style" : "",
					"text" : "+ 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 192.0, 67.5, 168.0, 53.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.300003, 86.0, 168.0, 53.0 ],
					"range" : 24,
					"style" : "",
					"varname" : "kslider",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 25.5, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.300003, 61.5, 75.0, 22.0 ],
					"style" : "",
					"text" : "Root Note",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 49.5, 85.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 13"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 27.0, 76.5, 93.875, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.300003, 31.0, 129.0, 23.0 ],
					"style" : "",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 160.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 21.0, 259.0, 260.0, 22.0 ],
					"style" : "",
					"text" : "+ 48"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 194.0, 176.0, 22.0 ],
					"style" : "",
					"text" : "pack 60 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 217.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "nth $2 $1"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 21.0, 236.0, 66.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 12.0, 370.75, 279.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.300003, 1.0, 222.500031, 147.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
