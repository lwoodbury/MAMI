...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 133.0, 181.0, 95.0, 22.0 ],
									"style" : "",
									"text" : "route #1_button"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 133.0, 149.0, 88.0, 22.0 ],
									"style" : "",
									"text" : "r mamiSerialIn"
								}
...
,
									"patching_rect" : [ 225.75, 90.0, 46.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 225.75, 57.0, 61.0, 22.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 225.75, 54.0, 110.0, 20.0 ],
									"rounded" : 5.0,
									"style" : "",
									"text" : "MIDI",
									"texton" : "In",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 30.0, 30.0, 110.0, 20.0 ],
									"rounded" : 5.0,
									"style" : "",
									"text" : "Serial",
									"texton" : "In",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 133.0, 17.0, 307.0, 20.0 ],
									"style" : "",
									"text" : "Choose input type: OSC, Serial, MIDI, key, mouse, HI"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 23.0, 90.0, 69.0, 22.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"style" : "",
									"text" : "thispatcher"
								}
