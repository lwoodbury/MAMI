...
,
									"patching_rect" : [ 492.75, 90.0, 57.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
									"patching_rect" : [ 446.75, 90.0, 39.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
									"patching_rect" : [ 334.75, 90.0, 33.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
									"patching_rect" : [ 283.75, 90.0, 47.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
									"patching_rect" : [ 142.75, 90.0, 49.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 159.0, 38.0, 150.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 492.75, 57.0, 48.0, 22.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 446.75, 57.0, 38.0, 22.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 334.75, 57.0, 100.0, 22.0 ],
									"presentation" : 1,
...
,
									"patching_rect" : [ 211.75, 90.0, 46.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 161.75, 333.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 67.800003, 79.0, 27.0, 15.0 ],
					"rounded" : 5.0,
					"style" : "",
					"text" : "Out",
					"texton" : "Out",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 67.800003, 60.5, 27.0, 15.0 ],
					"rounded" : 5.0,
					"style" : "",
					"text" : "In",
					"texton" : "In",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 69.300003, 93.300003, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 102.0, 273.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "t b 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 69.0, 191.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "t 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 3.000001, 191.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "t 1 100 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 33.666668, 156.0, 116.0, 22.0 ],
					"style" : "",
					"text" : "sel 0 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.666668, 117.0, 88.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.83333, 33.333332, 76.0, 21.0 ],
					"style" : "",
					"text" : "Timed",
					"textcolor" : [ 0.996078, 0.996078, 0.996078, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.666668, 101.0, 87.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.666668, 85.0, 87.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.83333, 1.333332, 76.0, 21.0 ],
					"style" : "",
					"text" : "Momentary",
					"textcolor" : [ 0.996078, 0.996078, 0.996078, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 33.666668, 85.0, 109.5, 50.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.83333, 55.852802, 59.0, 59.0 ],
					"prototypename" : "GRN_lozenge_LiveTog",
					"rounded" : 59.0,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.8, 0.3, 95.0, 117.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 107.833336, 187.5, 111.5, 187.5 ],
					"source" : [ "obj-37", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 31.5, 231.0, 402.5, 231.0 ],
					"source" : [ "obj-38", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 12.500001, 240.0, 336.5, 240.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 50.5, 221.0, 221.0, 221.0, 221.0, 88.0, 303.5, 88.0 ],
					"source" : [ "obj-38", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 78.5, 240.0, 336.5, 240.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 93.5, 221.0, 221.5, 221.0, 221.5, 88.0, 303.5, 88.0 ],
					"source" : [ "obj-39", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 124.0, 308.0, 321.25, 308.0, 321.25, 286.0, 336.5, 286.0 ],
					"source" : [ "obj-49", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 136.5, 299.0, 221.75, 299.0, 221.75, 88.0, 303.5, 88.0 ],
					"source" : [ "obj-49", 2 ]
				}
