...
,
					"patching_rect" : [ 168.5, 54.0, 51.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.0, 30.5, 227.0, 47.0 ],
					"style" : "",
					"text" : "NB - Need to tell dial what range we are working with "
				}
...
,
					"patching_rect" : [ 278.0, 168.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
									"patching_rect" : [ 533.5, 371.0, 51.0, 22.0 ],
									"presentation_rect" : [ 518.5, 349.0, 0.0, 0.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 633.0, 290.0, 36.0, 22.0 ],
									"style" : "",
									"text" : "sel 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 633.0, 249.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "+ 1"
								}
...
,
									"patching_rect" : [ 416.5, 341.0, 61.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 633.0, 32.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 373.75, 441.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 642.5, 278.099976, 408.5, 278.099976 ],
									"order" : 1,
									"source" : [ "obj-17", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 642.5, 334.5, 468.0, 334.5 ],
									"source" : [ "obj-18", 0 ]
								}
...
,
					"patching_rect" : [ 228.0, 54.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 203.0, 168.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.5, 116.0, 31.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlinecolor" : [ 0.501961, 0.662745, 0.67451, 1.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 228.0, 96.0, 62.0, 62.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 228.0, 30.5, 27.0, 15.0 ],
					"presentation" : 1,
